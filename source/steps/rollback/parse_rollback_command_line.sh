...
function parse_rollback_command_line
{
    ...
    rollback_option_load_config_file "$option_config_file" || return $?
    ...
    rollback_option_validate_paths "$option_deploy_path" "option_current_path" "option_releases_path" "option_shared_path" || return $?

    rollback_option_validate_servers || return $?
    rollback_option_validate_connect_option || return $?
...
readonly -f "parse_rollback_command_line"

function rollback_option_load_config_file
{
    declare -r file="$1"
...
readonly -f "rollback_option_load_config_file"

function rollback_option_validate_paths
{
...
readonly -f "rollback_option_validate_paths"

function rollback_option_validate_servers
{
...
"
    ...
    # compatibility with other scripts: we only use this variable outside of this file
...
readonly -f "rollback_option_validate_servers"

function rollback_option_validate_connect_option
{
...
readonly -f "rollback_option_validate_connect_option"
